...
namespace FK.Common
{
    ...
    public class SceneInfo
    {
        ...
        public bool AllowAutoActivation => AsyncOperation?.allowSceneActivation ?? false;
        public float Progress => AsyncOperation?.progress ?? -1f;
        public bool IsPreloaded => AsyncOperation?.progress >= 0.9f;
        public bool IsActivated => AsyncOperation?.isDone ?? false;
